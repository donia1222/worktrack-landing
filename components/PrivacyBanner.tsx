  ...
  return (
    <section className="bg-white px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -left-16 top-1/2 h-64 w-64 -translate-y-1/2 rounded-full bg-emerald-200/40 blur-3xl"
        />
        ...
        <div className="relative flex flex-col gap-7 lg:flex-row lg:items-center lg:gap-10">
          ...
          <div className="flex flex-1 items-start gap-4 sm:gap-5">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-50 ring-1 ring-inset ring-emerald-200 sm:h-14 sm:w-14">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 border-slate-200 pt-1 lg:shrink-0 lg:flex-col lg:gap-4 lg:border-l lg:pl-10 lg:pt-0">
